...
export class RecoverPasswordService {
  ...
  async execute(): Promise<RecoverPasswordServiceResult> {
    ...
    this.mailer.send({
      ...
      to: this.email,
      subject: "Recuperación de contraseña en b2pallet",
      text: `
        Hola,

        Para crear una nueva contraseña en b2pallet, ingrese este código de confirmación en la pantalla de su navegador.
      ...
      html: `
        ...
        <p> Para crear una nueva contraseña en b2pallet, ingrese este c&oacute;digo de confirmaci&oacute;n en la pantalla de su navegador.</p>
